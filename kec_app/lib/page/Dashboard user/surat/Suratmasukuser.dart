...
import 'package:kec_app/page/Dashboard%20user/DetailSuratMasuk.dart';

class SuratMasukUser extends StatefulWidget {
  const SuratMasukUser({super.key});

  @override
  State<SuratMasukUser> createState() => _SuratMasukUserState();
}

class _SuratMasukUserState extends State<SuratMasukUser> {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            => DetailSuratMasukUser(documentSnapshot: documentSnapshot)));
                          },
