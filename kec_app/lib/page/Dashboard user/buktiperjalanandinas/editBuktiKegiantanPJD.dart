...
class _EditButkiKegiantanPjdState extends State<EditButkiKegiantanPjd> {
  ...
  final _alamat_pengirim = TextEditingController();
  ...
  void initState() {
    ...
    _alamat_pengirim.text = documentSnapshot['alamat_pengirim'];
  ...
  Widget build(BuildContext context) {
    var _selectNomor = documentSnapshot['no_berkas'];
    return Scaffold(
      appBar: AppBar(
        elevation: 0.0,
        leading: IconButton(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        return DropdownSearchUpdate(
                          ...
                          onChage: (value) {
                            _selectNomor = value!;
                            getDataByNomor(value).then((result) {
                              _alamat_pengirim.text =
                                  result['alamat_pengirim']!;
                            });
                          },
                          selectedItems: _selectNomor,
                        );
                      } else {
                        ...
                        onPressed: _isLoading
                            ...
                            : () async {
                                ...
                                final String alamat_pengirim =
                                    _alamat_pengirim.text;
                                final String no_berkas = _selectNomor;
