...
import 'package:kec_app/page/Dashboard%20user/DetailSuratKeluar.dart';

class SuratKeluarUser extends StatefulWidget {
  const SuratKeluarUser({super.key});

  @override
  State<SuratKeluarUser> createState() => _SuratKeluarUserState();
}

class _SuratKeluarUserState extends State<SuratKeluarUser> {
                          ...
                          child: ListTile(
                            onTap: () {
                              Navigator.of(context).push(CupertinoPageRoute(
                                  builder: ((context) => DetailSuratKeluarUser(
