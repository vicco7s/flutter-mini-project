...
import 'package:kec_app/page/Dashboard%20Camat/detailpage/DetailSuratMasuk.dart';


class SuratMasukCamat extends StatefulWidget {
  const SuratMasukCamat({super.key});

  @override
  State<SuratMasukCamat> createState() => _SuratMasukCamatState();
}

class _SuratMasukCamatState extends State<SuratMasukCamat> {
  final _formkey = GlobalKey<FormState>();

  String search = '';

  final Query<Map<String, dynamic>> _suratmasuk =
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            => DetailSuratMasukCamat(documentSnapshot: documentSnapshot)));
                          },
