...
class ReportJmSuratMasuk extends StatefulWidget {
  const ReportJmSuratMasuk({super.key});

  @override
  State<ReportJmSuratMasuk> createState() => _ReportJmSuratMasukState();
}

class _ReportJmSuratMasukState extends State<ReportJmSuratMasuk> {
  List<String> years = [];
  ...
  Future<void> fetchYearsFromFirestore() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('suratmasuk').get();
